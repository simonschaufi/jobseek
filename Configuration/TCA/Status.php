...
$TCA['tx_jobseek_domain_model_status'] = array(
	'ctrl' => $TCA['tx_jobseek_domain_model_status']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_jobseek_domain_model_status.pid=###CURRENT_PID### AND tx_jobseek_domain_model_status.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:jobseek/Resources/Private/Language/locallang_db.xml:tx_jobseek_domain_model_status.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
